...
namespace UnitTests
{
    ...
    public class StringTests
    {
        ...
        public void anchor()
        {
            Assert.AreEqual(@"<a name=""undefined"">haha</a>", (string)TestUtils.Evaluate("'haha'.anchor()"));
            Assert.AreEqual(@"<a name=""test"">haha</a>", (string)TestUtils.Evaluate("'haha'.anchor('test')"));
        ...
        public void big()
        {
            Assert.AreEqual("<big>haha</big>", (string)TestUtils.Evaluate("'haha'.big()"));
        ...
        public void blink()
        {
            Assert.AreEqual("<blink>haha</blink>", (string)TestUtils.Evaluate("'haha'.blink()"));
        ...
        public void bold()
        {
            Assert.AreEqual("<b>haha</b>", (string)TestUtils.Evaluate("'haha'.bold()"));
        ...
        public void @fixed()
        {
            Assert.AreEqual("<tt>haha</tt>", (string)TestUtils.Evaluate("'haha'.fixed()"));
        ...
        {
            Assert.AreEqual(@"<font color=""undefined"">haha</font>", (string)TestUtils.Evaluate("'haha'.fontcolor()"));
            Assert.AreEqual(@"<font color=""red"">haha</font>", (string)TestUtils.Evaluate("'haha'.fontcolor('red')"));
        ...
        {
            Assert.AreEqual(@"<font size=""5"">haha</font>", (string)TestUtils.Evaluate("'haha'.fontsize(5)"));
            Assert.AreEqual(@"<font size=""abc"">haha</font>", (string)TestUtils.Evaluate("'haha'.fontsize('abc')"));
            Assert.AreEqual(@"<font size=""undefined"">haha</font>", (string)TestUtils.Evaluate("'haha'.fontsize()"));
        ...
        public void italics()
        {
            Assert.AreEqual("<i>haha</i>", (string)TestUtils.Evaluate("'haha'.italics()"));
        ...
        public void link()
        {
            Assert.AreEqual(@"<a href=""undefined"">haha</a>", (string)TestUtils.Evaluate("'haha'.link()"));
            Assert.AreEqual(@"<a href=""http://www.beer.com"">haha</a>", (string)TestUtils.Evaluate("'haha'.link('http://www.beer.com')"));
        ...
        public void small()
        {
            Assert.AreEqual("<small>haha</small>", (string)TestUtils.Evaluate("'haha'.small()"));
        ...
        public void strike()
        {
            Assert.AreEqual("<strike>haha</strike>", (string)TestUtils.Evaluate("'haha'.strike()"));
        ...
        public void sub()
        {
            Assert.AreEqual("<sub>haha</sub>", (string)TestUtils.Evaluate("'haha'.sub()"));
        ...
        public void sup()
        {
            Assert.AreEqual("<sup>haha</sup>", (string)TestUtils.Evaluate("'haha'.sup()"));
