...
namespace UnitTests
{
    ...
    public class NumberTests
    {
        ...
        public void toLocaleString()
        {
            if (TestUtils.Engine != JSEngine.JScript)
            {
                Assert.AreEqual((77.0).ToString(), TestUtils.Evaluate("77 .toLocaleString()"));
                Assert.AreEqual((77.5).ToString(), TestUtils.Evaluate("77.5.toLocaleString()"));
            ...
            Assert.AreEqual(double.PositiveInfinity.ToString(), TestUtils.Evaluate("Infinity.toLocaleString()"));
            Assert.AreEqual(double.NegativeInfinity.ToString(), TestUtils.Evaluate("(-Infinity).toLocaleString()"));
            Assert.AreEqual(double.NaN.ToString(), TestUtils.Evaluate("NaN.toLocaleString()"));
